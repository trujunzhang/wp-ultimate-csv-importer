...
<div class="accordion" id="accordion2" style='width:98%;' xmlns="http://www.w3.org/1999/html">
    <div class="accordion-group">
        <div id="collapseTwo" class="accordion-body in collapse">
            <span style="margin: 4% 0px 4% 22%; color: red; font-weight: bold; text-align: center;" name="warning"
                  id="warning"><p><?php echo esc_html__('Check', 'wp-ultimate-csv-importer'); ?> <a
                        href='<?php echo $siteurl ?>/wp-admin/admin.php?page=wp-ultimate-csv-importer/index.php&__module=settings'
                        target='blank'> <?php echo esc_html__('here', 'wp-ultimate-csv-importer'); ?> </a> <?php echo esc_html__('your system configuration before proceeding the export. It may help to prevent from facing server configuration issues.', 'wp-ultimate-csv-importer'); ?> </span><span
                style='position:relative;left:4px;'></span></p></span>
            <div class="accordion-inner">
                <div>
                    <label><h3
                            id="exporttitle"><?php echo esc_html__('Export Data With Advanced Filters', 'wp-ultimate-csv-importer'); ?></h3>
                    </label>
                </div>
                <div style="margin-left:20px;">
                    <?php if (!isset($_REQUEST['step'])) { ?>
                    <form class="form-horizontal" method="post" name="exportmodule" id="exportmodule"
                          action='<?php echo esc_url(add_query_arg(array('page' => WP_CONST_ULTIMATE_CSV_IMP_SLUG . '/index.php', '__module' => sanitize_text_field($_REQUEST['__module']), 'step' => 'exportfilters'), $impCE->baseUrl)) ?>'
                            ...
                            <div class="table-responsive" id="exporttable">
                                <table class='table exportmodule'>
                                    <th colspan='2'><label class='h-exportmodule'><h3
                                                id="innertitle"><?php echo esc_html__('Select your module to export the data', 'wp-ultimate-csv-importer') ?> </h3>
                                        </label></th>
                                    <tr>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="post"><span
                                                    id="align"><?php echo esc_html__('Post', 'wp-ultimate-csv-importer'); ?></span>
                                            </label></td>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="eshop"><span
                                                    id="align"><?php echo esc_html__('Eshop', 'wp-ultimate-csv-importer'); ?></span>
                                            </label></td>
                                    </tr>
                                    <tr>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="page"><span
                                                    id="align"> <?php echo esc_html__('Page', 'wp-ultimate-csv-importer'); ?></span>
                                            </label></td>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="wpcommerce"><span
                                                    id="align"> <?php echo esc_html__('Wp-Commerce', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class='exportdatatype'>
                                            <label> <input type="radio" name="export" value="custompost"><span
                                                    id="align"> <?php echo esc_html__('Custom Post', 'wp-ultimate-csv-importer'); ?></span></label>
                                        ...
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                    ...
                                                    id="align"> <?php echo esc_html__('Woo-Commerce', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="categories"><span
                                                    id="align"> <?php echo esc_html__('Category', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="marketpress"><span
                                                    id="align"> <?php echo esc_html__('Marketpress', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="tags"><span
                                                    id="align"> <?php echo esc_html__('Tags', 'wp-ultimate-csv-importer'); ?>
                                            </label></span></td>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="customerreviews"><span
                                                    id="align"> <?php echo esc_html__('Customer Reviews', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class='exportdatatype'>
                                            <label> <input type="radio" name="export" value="customtaxonomy"><span
                                                    id="align"> <?php echo esc_html__('Custom Taxonomy', 'wp-ultimate-csv-importer'); ?></span></label>
                                            <select name="export_taxo_type" id="export_taxo_type"
                                                    style="margin-left:10px;">
                                                <option><?php echo esc_html__('--Select--', 'wp-ultimate-csv-importer'); ?></option>
                                                <?php
                                        ...
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="comments"><span
                                                    id="align"> <?php echo esc_html__('Comments', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class='exportdatatype'><label> <input type="radio" name="export"
                                                                                  value="users"><span
                                                    id="align"> <?php echo esc_html__('Users', 'wp-ultimate-csv-importer'); ?></span></label>
                                        </td>
                                        <td class='exportdatatype'></td>
                                    </tr>
                                </table>
                                <div class='' style="padding: 15px;float: right;"><input type="submit"
                                                                                         name="proceedtoexclusion"
                                                                                         id="proceedtoexclusion"
                                                                                         value="<?php echo esc_html__('Proceed', 'wp-ultimate-csv-importer'); ?>"
                ...
                <?php if (isset($_REQUEST['step']) && sanitize_text_field($_REQUEST['step']) === 'exportfilters') { ?>
                    ...
                    <div id="exportmodulefilter" style="">
                        <div class="table-responsive">
                            <form name="exportbasedonfilters" method="post"
                                  action="<?php echo admin_url('admin-ajax.php'); ?>">
                                <?php wp_nonce_field('parseDataToExport', 'smack_nonce_key'); ?>
                                <table style='width:100%;' class='table exportmodule'>
                                    <th colspan='2'><label class='h-exportmodule'><h3
                                                id="innertitle"> <?php echo esc_html__('To export data based on the filters', 'wp-ultimate-csv-importer'); ?></h3>
                                        </label></th>
                                    <tr>
                                        <td><label><input type='checkbox' name='getdatawithdelimiter'
                                                          id='getdatawithdelimiter' value='getdatawithdelimiter'
                                                          onclick='addexportfilter(this.id);'/><span
                                                    id="align"> <?php echo esc_html__('Export data with auto delimiters'); ?></span></label>
                                            <div id='delimiterstatus'
                                                 style='padding:15px;margin-left:24px;display:none;'>
                                                ...
                                                <label><b>Other Delimiters</b> </label><input type='text'
                                    ...
                                    <?php if ($export_type !== 'categories' && $export_type !== 'tags' && $export_type !== 'customtaxonomy') { ?>
                                        <tr>
                                            <td><label><input type='checkbox' name='getdataforspecificperiod'
                                                              id='getdataforspecificperiod'
                                                              value='getdataforspecificperiod'
                                                              onclick='addexportfilter(this.id);'/><span
                                                        id="align"> <?php echo esc_html__('Export data for the specific period', 'wp-ultimate-csv-importer'); ?></span></label>
                                                <div id='specificperiodexport'
                                                     style='padding:10px;margin-left:29px;display:none;'>
                                                    <label
                                                        id='periodstartfrom'><b> <?php echo esc_html__('Start From', 'wp-ultimate-csv-importer'); ?> </b></label>
                                                    <input type='text' class='form-control' name='postdatefrom'
                                                           style='cursor:default;width:25%;' readonly id='postdatefrom'
                                                           value='' onchange='validateDateIntervals();'/>
                                                    <label
                                                        id='periodendto'><b><?php echo esc_html__('End To', 'wp-ultimate-csv-importer'); ?> </b></label>
                                                    <input type='text' class='form-control' name='postdateto'
                                                           style='cursor:default;width:25%;' readonly id='postdateto'
                                                           value='' onchange='validateDateIntervals();'/>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <?php if ($export_type !== 'users' && $export_type !== 'categories' && $export_type !== 'tags' && $export_type !== 'customtaxonomy' && $export_type !== 'customerreviews' && $export_type !== 'comments') { ?>
                                        <tr>
                                            <td><label><input type='checkbox' name='getdatawithspecificstatus'
                                                              id='getdatawithspecificstatus'
                                                              value='getdatawithspecificstatus'
                                                              onclick='addexportfilter(this.id);'/><span
                                                        id="align"> <?php echo esc_html__('Export data with the specific status', 'wp-ultimate-csv-importer'); ?></span></label>
                                                <div id='specificstatusexport'
                                                     style='padding:15px;margin-left:24px;display:none;'>
                                                    <label
                                                        id='status'><b> <?php echo esc_html__('Status', 'wp-ultimate-csv-importer'); ?> </b></label>
                                                    <select name='specific_status' id='specific_status'
                                                            style='margin-left:5px;margin-top:-7px;'>
                                    ...
                                    if ($export_type !== 'users' && $export_type !== 'categories' && $export_type !== 'tags' && $export_type !== 'customtaxonomy' && $export_type !== 'customerreviews') { ?>
                                        <tr>
                                            <td><label><input type='checkbox' name='getdatabyspecificauthors'
                                                              id='getdatabyspecificauthors'
                                                              value='getdatabyspecificauthors'
                                                              onclick='addexportfilter(this.id);'/><span
                                                        id="align"> <?php echo esc_html__('Export data by specific authors', 'wp-ultimate-csv-importer'); ?></span></label>
                                                <div id='specificauthorexport'
                                                     style='padding:15px;margin-left:24px;display:none;'>
                                                    <label
                                                        id='authors'><b> <?php echo esc_html__('Authors', 'wp-ultimate-csv-importer'); ?> </b></label>
                                                    <?php $blogusers = get_users('blog_id=1&orderby=nicename'); ?>
                                                    <select name='specific_authors' id='specific_authors'
                                                            style='margin-left:5px;margin-top:-7px;'>
                                                        <option
                                                            value='0'><?php echo esc_html__('All', 'wp-ultimate-csv-importer'); ?></option>
                                    ...
                                    <tr>
                                        <td>
                                            <!--<label><input type='checkbox' name='getdatabasedonexclusions' id='getdatabasedonexclusions' value='getdatabasedonexclusions' onclick='addexportfilter(this.id);' /><span id="align"> <?php echo esc_html__('Export data based on specific exclusions', 'wp-ultimate-csv-importer'); ?> </span></label>-->
                                            <div id="exclusiongrouplist" style="display:none;">
                                                ...
                                                <div class="panel-group" id="accordion"
                                                     style="width:98.3%;margin-top:-5px;padding-bottom: 20px;">
                                                    <input type='hidden' name='moduletobeexport' id='moduletobeexport'
                                                           value='<?php echo isset($_POST['export']) ? sanitize_text_field($_POST['export']) : ''; ?>'>
                                                    <input type='hidden' name='export_cust_type' id='export_cust_type'
                                                           value='<?php echo $exportAs; ?>'/>
                                                    <input type='hidden' name='export_taxo_type' id='export_taxo_type'
                                                           value='<?php echo $exportAs; ?>'/>
                                                    <input type="hidden" name="optional_type" id="optional_type"
                                                           value="<?php echo $exportAs; ?>">
                                                    <input type="hidden" name="offset" id="offset" value="0">
                                                    <input type="hidden" name="limit" id="limit" value="10">
                                                    <input type="hidden" name="total_row_count" id="total_row_count"
                                                           value="">
                                                    ...
                                                    <?php if (in_array('CORE', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Core_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("WordPress Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-up pull-right'
                                                                          id='Core_Fields_h_span'> </span>
                                                                </div>
                                                            </div>
                                                            <div id="Core_Fields" class="panel-collapse collapse in"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent" id="corefields_content"
                                                                     style="height:250px;">
                                                                    <div style="padding-top:5px">
		   <span style="margin-left:800px;">
                      	<a id="check" onclick="exportselectall(this.id,'CORE');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'CORE');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
              	  </span>
                                                                    </div>
                                                                    ...
                                                                    if (is_array($get_core_fields) && !empty($get_core_fields['CORE'])) {
                                                                        ...
                                                                        echo "<p style='color:red;text-align:center;padding:20px;'>";
                                                                        echo esc_html__('No fields Found!', 'wp-ultimate-csv-importer');
                                                                        echo "</p>";
                                                    ...
                                                    <?php if (in_array('CCTM', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Cctm_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("CCTM Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Cctm_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Cctm_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent " id="cctmfields_content">
                                                                    <div>
                   <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'CCTM');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'CCTM');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                   </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('ACF', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Acf_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("ACF Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Acf_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Acf_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent " id="acffields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'ACF');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'ACF');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('RF', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Rf_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("ACF Repeater Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Rf_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Rf_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="repeaterfields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'RF');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'RF');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('TYPES', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Types_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("Types Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Types_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Types_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="typesfields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'TYPES');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'TYPES');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer') ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('PODS', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Pods_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("PODS Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Pods_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Pods_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent " id="podsfields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'PODS');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'PODS');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('AIOSEO', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Aioseo_Fields" data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("All in One SEO Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Aioseo_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Aioseo_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="aioseofields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'AIOSEO');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'AIOSEO');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('YOASTSEO', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Yoastseo_Fields"
                                                                 data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("WordPress Yoast SEO Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Yoastseo_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Yoastseo_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="yoastseofields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'YOASTSEO');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'YOASTSEO');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('CORECUSTFIELDS', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Othercustom_Fields"
                                                                 data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("Other WP Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Othercustom_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Othercustom_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="othercustomfields_content">
                                                                    <div>
               <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'CORECUSTFIELDS');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'CORECUSTFIELDS');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?> </a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('WPMEMBERS', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Wpmember_Fields"
                                                                 data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("WP Member Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Wpmember_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Wpmember_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="wpmemberfields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'WPMEMBERS');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'WPMEMBERS');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('ECOMMETA', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Ecommeta_Fields"
                                                                 data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("Ecommerce Meta Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Ecommeta_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Ecommeta_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="ecommetafields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'ECOMMETA');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'ECOMMETA');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('WPECOMMETA', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Wpecomcust_Fields"
                                                                 data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("WP-eCommerce Custom Fields: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Wpecomcust_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Wpecomcust_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="wpecomcustfields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'WPECOMMETA');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'WPECOMMETA');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer'); ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                                    ...
                                                    <?php if (in_array('TERMS', $available_groups)) { ?>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" data-toggle="collapse"
                                                                 data-target="#Termtaxos_Fields"
                                                                 data-parent="#accordion">
                                                                <div class="panel-title">
                                                                    <b> <?php echo esc_html__("Terms & Taxonomies: ", 'wp-ultimate-csv-importer'); ?></b>
                                                                    <span class='fa fa-toggle-down pull-right'
                                                                          id='Termtaxos_Fields_h_span'> </span></div>
                                                            </div>
                                                            <div id="Termtaxos_Fields" class="panel-collapse collapse"
                                                                 style="height:auto;">
                                                                <div class="grouptitlecontent "
                                                                     id="termtaxofields_content">
                                                                    <div>
                <span style="margin-left:800px;">
                        <a id="check" onclick="exportselectall(this.id,'TERMS');"
                           value="Check All"><?php echo esc_html__('Check All', 'wp-ultimate-csv-importer'); ?></a></span>
                                                                        <span style="margin-left:1px;">
                        <a id="uncheck" onclick="exportselectall(this.id,'TERMS');"
                           value="Un Check All "> <?php echo esc_html__('/ Uncheck All', 'wp-ultimate-csv-importer') ?></a>
                </span>
                                                                    </div>
                                                                    <?php
                                ...
                                <div class='form-group exportedas'>
                                    <label
                                        class='col-sm-2 control-label'><b><?php echo esc_html__('File Name: ', 'wp-ultimate-csv-importer'); ?></b></label>
                                    <div class='col-sm-6'>
                                        <input class='form-control' type='text' name='export_filename'
                                               id='export_filename' value=''
                                               placeholder="export_as_<?php echo(date("Y-m-d")); ?>" size="18"
                                               style="margin-left:-67px;margin-top:-8px;">
                                    </div>
                                    <a id="download_file_link" href="" target="_blank" class="col-sm-2"
                                       style="margin-top: -10px; display: none;"> <input type="button"
                                                                                         name="download_file"
                                                                                         id="download_file"
                                ...
                                <div style="padding:15px;width:100% !important;" class='col-sm-3'>
                                    <input type='hidden' name='export' id='export'
                                           value='<?php if (isset($_POST['export'])) {
                                               echo sanitize_text_field($_POST['export']);
                                           } ?>'/>
                                    ...
                                    <input type='hidden' name='export_cpt_type' id='export_cpt_type'
                                           value='<?php echo $export_cpt_type; ?>'/>
                                    <input type='hidden' name='export_custtaxo_type' id='export_custtaxo_type'
                                           value='<?php echo $export_custtaxo_type; ?>'/>
                                    <input type="button" name="backtomodulechooser" id="backtomodulechooser"
                                           value="<?php echo esc_attr__('<< Back'); ?>" class='btn btn-danger'
                                           onclick="window.location.href = '<?php echo admin_url() . 'admin.php?page=' . WP_CONST_ULTIMATE_CSV_IMP_SLUG . '/index.php&__module=' . $_REQUEST['__module'] ?>'"
                                           style="float:left;">
                                    <input type="button" name="proceed_to_export" id="proceed_to_export"
                                           value="<?php echo esc_attr__('Export', 'wp-ultimate-csv-importer'); ?>"
                                           class='btn btn-success' style="float:right;" onclick="igniteExport();">
                                </div>
                            </form>
                        </div>
                    </div>
