...
<div style="width:100%;">
            ...
            <tr>
                <td>
                    ...
                    <div
                        ...
                        <form
                            action='<?php echo esc_url(add_query_arg(array('page' => WP_CONST_ULTIMATE_CSV_IMP_SLUG . '/index.php', '__module' => sanitize_text_field($_REQUEST['__module']), 'step' => 'mapping_settings'), $impCE->baseUrl)); ?>'
    ...
    <tr>
        <td>
            <form name='mappingConfig'
                ...
                <div
                    id='sec-two' <?php if (sanitize_text_field($_REQUEST['step']) !== 'mapping_settings') { ?> style='display:none;' <?php } ?> >
                            ...
                            <div class='importstatus' style=''>
                                        ...
                                        if (is_array(get_post_types())) {
                                            foreach (get_post_types() as $key => $value) {
                                                ...
                                                if (($value !== 'featured_image') && ($value !== 'attachment') && ($value !== 'wpsc-product') && ($value !== 'wpsc-product-file') && ($value !== 'revision') && ($value !== 'nav_menu_item') && ($value !== 'post') && ($value !== 'page') && ($value !== 'wp-types-group') && ($value !== 'wp-types-user-group') && ($value !== 'product') && ($value !== 'product_variation') && ($value !== 'shop_order') && ($value !== 'shop_coupon') && ($value !== 'acf') && ($value !== 'acf-field-group') && ($value !== 'acf-field') && ($value !== '_pods_pod') && ($value !== '_pods_field') && ($value !== 'mp_order') && ($value !== 'createdByTypes') && ($value !== 'createdByCCTM') && ($value !== 'createdByPODS')) { ?>
                                                    <!-- TODO: DJZHANG-->
                                                    <option
                                                        id="<?php echo($value); ?>"> <?php echo(str_replace("shop_webhook", "product", $value)); ?> </option>
                                                    <?php
                                ...
                                <div style='float:left'>
                                    <a href="#" class="tooltip">
                                        <img
                                            src="<?php echo esc_url(WP_CONST_ULTIMATE_CSV_IMP_DIR . 'images/help.png'); ?>"/>
			...
			<img src="<?php echo esc_url(WP_CONST_ULTIMATE_CSV_IMP_DIR . 'images/help.png'); ?>"
                    ...
                    <div id='mappingheader' class='mappingheader'>
                        ...
                        <table style="font-size: 12px;" class="table table-striped" id='FIELDGRP'>
                            ...
                            <tr>
                                <td colspan='4' class="left_align columnheader"
                                    ...
                                    <div id='custfield_core' style='font-size:18px; font-family:times;'>
                                        <b><?php echo esc_html__('WordPress Fields:', 'wp-ultimate-importer'); ?></b>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="columnheader" style='padding-left:55px;'>
                                    <b><?php echo esc_html__('CSV HEADER', 'wp-ultimate-csv-importer'); ?></b>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select name="mapping<?php print($count); ?>"
                                                        id="mapping<?php print($count); ?>" onChange=changefield();>
                                                    <?php }else{ ?>
                                                    <select name="mapping<?php print($count); ?>"
                        ...
                        <table style="font-size: 12px;" class="table table-striped" id='CF_FIELDGRP'>
                            <tr>
                                ...
                                <td colspan=5 class='left_align columnheader'
                                    style='background-color: #F5F5F5; border: 1px solid #d6e9c6;padding: 10px; width:100%;'>
                                    <div id='custfield_core' style='font-size:18px; font-family:times;'>
                                        <b><?php echo esc_html__('Custom Fields:', 'wp-ultimate-csv-importer'); ?></b>
                                    </div>
                        ...
                        <table style="font-size: 12px;" class="table table-striped" id='TERMS_FIELDGRP'>
                            <tr>
                                <td colspan=5 class='left_align columnheader'
                                    style='background-color: #F5F5F5; border: 1px solid #d6e9c6;padding: 10px; width:100%;'>
                                    <div id='terms_field' style='font-size:18px; font-family:times;'>
                                        <b><?php echo esc_html__('Terms / Taxonomies Fields:', 'wp-ultimate-csv-importer'); ?></b>
                                    </div>
                                </td>
                            </tr>
                            <?php
                                    ...
                                    if (strstr($key, 'TERMS:')) {
                                        ...
                                        <tr>
                                            <td class="left_align" style='width:53%;padding-left:150px'>
                                                ...
                                                <label
                                                    class='wpfields'><?php print('<b>' . $key . '</b></label><br><label class="samptxt" style="padding-left:20px">[Name: ' . $value . ']'); ?></label>
                                            </td>
                                            <td>
                            ...
                            <table style="font-size: 12px;" class="table table-striped" id='SEO_FIELDGRP'>
                                <tr>
                                    <td colspan=5 class='left_align columnheader'
                                        style='background-color: #F5F5F5; border: 1px solid #d6e9c6;padding: 10px; width:100%;'>
                                        <div id='custfield_core' style='font-size:18px; font-family:times;'>
                                            <b><?php echo esc_html__('SEO Fields:', 'wp-ultimate-csv-importer'); ?></b>
                                        </div>
                                    </td>
                                </tr>
                                <?php
                ...
                <img class="callout"
                     src="<?php echo esc_url(WP_CONST_ULTIMATE_CSV_IMP_DIR . 'images/callout.gif'); ?>"/>
    ...
    <tr>
        <td>
            ...
            <div
                id='sec-three' <?php if (sanitize_text_field($_REQUEST['step']) !== 'importoptions') { ?> style='display:none;' <?php } ?> >
                ...
                <?php if (isset($_POST)) { ?>
                    <input type='hidden' id='tmpLoc' name='tmpLoc'
                           value='<?php echo WP_CONST_ULTIMATE_CSV_IMP_DIR; ?>'/>
                    <input type='hidden' id='checkfile' name='checkfile'
...
<!--                            <input type='radio' id='scheduleNow' name='importMode' value=''-->
<!--                                   onclick='choose_import_mode(this.id);'-->
<!--                                   disabled/> --><?php //echo esc_html__("Schedule now", 'wp-ultimate-csv-importer'); ?>
<!--                            <img src="--><?php //echo esc_url(WP_CONST_ULTIMATE_CSV_IMP_DIR . 'images/pro_icon.gif'); ?><!--"-->
<!--                                 title="PRO Feature"/>-->
<!--                        </label>-->
                        ...
                        <div id='importrightaway' style='display:block'>
                            <form method="POST">
                                <ul id="settings">
                                    <li>
                                        <label id="importalign">
                                            <input name='duplicatecontent' id='duplicatecontent'
                                                   type="checkbox"
                                                   value="">
                                            <?php echo esc_html__('Detect duplicate post content', 'wp-ultimate-csv-importer'); ?>
                                        </label> <br>
                                        <input type='hidden' name='wpnoncekey' id='wpnoncekey'
                                               value='<?php echo $nonce_Key; ?>'/>
                                        <!-- TODO: DJZHANG-->
                                        <label id="importalign">
                                            <input name='duplicatetitle' id='duplicatetitle'
                                                   type="checkbox"
                                                   value=""
                                                   checked>
                                            <?php echo esc_html__('Detect duplicate post title', 'wp-ultimate-csv-importer'); ?>
                                        </label>
                                        <br>
                                        <label
									...
									<span class='msg' id='server_request_warning'
                                        ...
                                        <input type="hidden" id="terminateaction" name="terminateaction"
                                               value="continue"/>
                                        <label
                                            id="innertitle"><?php echo esc_html__('Media Options', 'wp-ultimate-csv-importer'); ?></label><br/>
                                        <label id='importalign'>
                                            <input type='checkbox' id='useexistingimages' name='useexistingimages'
                                                   value=''/> <?php echo esc_html__("Reuse image with same name in Media", 'wp-ultimate-csv-importer'); ?>
                                        </label> <?php echo $impCE->helpnotes('skipDuplicate'); ?> <br>
                                        <label id='importalign'> <input type='checkbox' id='multiimage'
                                                                        name='multiimage'
                                                                        value=''> <?php echo esc_attr__('Insert Inline Images', 'wp-ultimate-csv-importer'); ?>
                                        </label><br>
                                        <input type='hidden' id='inlineimagevalue' name='inlineimagevalue'
                                               value='none'/>
                                    </li>
                                </ul>
                                ...
                                <input class="btn btn-warning" type="button"
                                       value="<?php echo esc_attr__('Reload', 'wp-ultimate-csv-importer'); ?>"
                                       id="importagain"
